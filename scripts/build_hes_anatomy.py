...
BODY = """<div class="sheet">
  <div class="head">
    <div class="row">
      <div class="title"><div class="tt"><div class="sysmark">ACIDCAT . FILE FORMAT REFERENCE</div><h1>HES Anatomy</h1></div><acidcat-toggle aria-label="Cycle theme: light, dark, acid, house light, house dark"></acidcat-toggle></div>
...
BUILDS = """
  ...
  build("hes-head","byte",
    ...
    [
      ...
      {label:"init",k:"sync",r:[6,7],val:"$E100",
      ...
      {label:"size",k:"sync",r:[20,23],val:"0x3FE0 = 16,352",
      ...
      {label:"unused",k:"rsv",r:[28,31],val:"0",body:"Four bytes the block header reserves.",note:""},
