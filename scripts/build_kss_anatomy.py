...
BODY = """<div class="sheet">
  <div class="head">
    <div class="row">
      <div class="title"><div class="tt"><div class="sysmark">ACIDCAT . FILE FORMAT REFERENCE</div><h1>KSS Anatomy</h1></div></div>
...
BUILDS = """
  ...
  build("kss-head","byte",
    ...
    [
      ...
      {label:"load",k:"ptr",r:[4,5],val:"$81D0",body:"Where the init data is placed in the Z80 address space.",note:"little-endian."},
      {label:"init length",k:"size",r:[6,7],val:"0x0BD0 = 3,024",
       body:"Bytes of init data. 16 + 3,024 = 3,040, the file: no banks in this one.",note:""},
      {label:"init",k:"ptr",r:[8,9],val:"$81D0",body:"Called with the song number in A. Here it is the first byte of the data.",note:""},
      {label:"play",k:"ptr",r:[10,11],val:"$81DA",body:"Called every tick, ten bytes in.",note:""},
      ...
      {label:"reserved",k:"pad",r:[14,14],val:"0",body:"In KSSX this is the extension size.",note:""},
