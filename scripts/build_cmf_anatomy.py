...
BUILDS = """
  ...
  build("cmf-head","byte",
    ...
    [
      ...
      {label:"instruments at",k:"sync",r:[6,7],val:"0x0028 = 40",body:"Right after this header.",note:""},
      {label:"music at",k:"sync",r:[8,9],val:"0x0088 = 136",body:"40 + 6 patches of 16 = 136.",note:""},
      ...
      {label:"title, composer, remarks",k:"rsv",r:[14,19],val:"0, 0, 0",body:"No strings in this file.",note:"offsets when present."},
      ...
      {label:"instrument count",k:"sync",r:[36,37],val:"6",body:"1.1 only.",note:""},
  ...
  build("cmf-inst","byte",
    ...
    [
      ...
      {label:"reserved",k:"rsv",r:[11,15],val:"0",body:"Five bytes.",note:""}
    ]);
