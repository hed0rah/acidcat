...
BODY = """<div class="sheet">
  <div class="head">
    <div class="row">
      <div class="title"><div class="tt"><div class="sysmark">ACIDCAT . FILE FORMAT REFERENCE</div><h1>VGM Anatomy</h1></div></div>
  ...
  build("vgm-head","byte",
    ...
    [
      {label:"magic",k:"sync",r:[0,3],val:"\\"Vgm \\"",
       ...
       note:"56 67 6D 20."},
      {label:"eof offset",k:"size",r:[4,7],val:"0x291C -> file ends at 10,528",
      ...
      {label:"YM2413 clock",k:"enum",r:[16,19],val:"0",
       ...
       note:""},
      {label:"GD3 offset",k:"ptr",r:[20,23],val:"0x2812 -> tag at 10,278",
       body:"Relative to this field: 0x2812 + 0x14 = 10,278, where the four bytes Gd3 begin.",
       note:"add 0x14."},
      {label:"total samples",k:"size",r:[24,27],val:"2,230,053 = 50.6 s",
      ...
      {label:"loop offset",k:"ptr",r:[28,31],val:"0x32F -> loops to 843",
       body:"Relative to this field: 0x32F + 0x1C = 843, a command in the stream. Zero would mean the tune does not loop.",
       note:"add 0x1C."},
      {label:"loop samples",k:"size",r:[32,35],val:"1,714,020 = 38.9 s",
      ...
      {label:"rate",k:"enum",r:[36,39],val:"60 Hz",
       ...
       note:"0 = unspecified."},
      {label:"reserved",k:"pad",r:[40,63],val:"0",
  ...
  build("vgm-cmds","byte",
    ...
    [
      ...
      {label:"volumes",k:"enum",r:[14,21],val:"0x9F 0xBF 0xDF 0xFF",
       ...
       note:"0xF = silent."},
      {label:"wait",k:"size",r:[22,24],val:"0x61 63 samples",
  ...
  build("vgm-gd3","byte",
    ...
    [
      ...
      {label:"version",k:"enum",r:[4,7],val:"0x00000100",
       ...
       note:""},
      {label:"length",k:"size",r:[8,11],val:"238 bytes",
      ...
      {label:"title (JP)",k:"pad",r:[36,37],val:"empty",
