  ...
  <div>
    ...
    <details class="region">
      ...
      <div class="rbody">
        ...
        <div class="kv">
          <div><span class="k">TMA</span><span class="v">the timer's modulo, what it reloads to</span></div>
          <div><span class="k">TAC</span><span class="v">the timer's control: enable and clock select</span></div>
        </div>
      </div>
    </details>
    ...
    <details class="region">
      ...
      <div class="rbody">
        ...
        variants, and the engine's own code handles any banking, so there was nothing for the header
        to say. The song count and the first song are the whole of the per-song information.</p>
      </div>
    </details>
