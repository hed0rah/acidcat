...
export ACIDCAT_S98_CORPUS="$root/S98"
export ACIDCAT_CMF_CORPUS="$root/Ad Lib"
export ACIDCAT_YM_CORPUS="$root/YM"
export ACIDCAT_SNDH_CORPUS="$root/SNDH"
...
export ACIDCAT_S3P_CORPUS="$root/AKAI Advance Orchestra Upgrade 97 Vol.1"
