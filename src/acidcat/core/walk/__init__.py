...
_WALKERS = {
    ...
    "sndh": ("Atari ST SNDH tune (68000 player, usually Pack-Ice packed)",
             lambda path, deep: sndh.inspect_sndh(path, deep=deep)),
    "ym": ("ST-Sound YM2149 register dump (YM, usually LHA-packed)",
           lambda path, deep: ym.inspect_ym(path, deep=deep)),
